...
- Visual system activation and blocking
- Data exposure indicator (Low / Medium / High)
- Client-side consent persistence using `localStorage`
...
## 📊 How It Works
1. Users adjust session behavior using sliders
2. Consent choices determine which systems activate
3. Simulated data output updates in real time
4. Exposure level reflects overall privacy impact
5. No real cookies or tracking are used
